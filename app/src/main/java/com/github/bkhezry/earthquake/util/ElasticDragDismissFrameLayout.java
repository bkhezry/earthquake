...
public class ElasticDragDismissFrameLayout extends FrameLayout {
    ...
    if (Math.abs(totalDrag) >= dragDismissDistance) {
      ...
      if (mLastActionEvent == MotionEvent.ACTION_DOWN) {
        ...
        animate()
            ...
            .scaleY(1f)
            .setDuration(200L)
            .setInterpolator(AppUtil.Companion.getFastOutSlowInInterpolator())
            .setListener(null)
            .start();
      }
      totalDrag = 0;
  ...
  public static class SystemChromeFader extends ElasticDragDismissCallback {
    ...
    public SystemChromeFader(Activity activity) {
      ...
      fadeNavBar = AppUtil.Companion.isNavBarOnBottom();
    }
    ...
    public void onDrag(float elasticOffset, float elasticOffsetPixels,
      ...
      if (elasticOffsetPixels > 0) {
        ...
        activity.getWindow().setStatusBarColor(AppUtil.Companion.modifyAlpha(activity.getWindow()
            .getStatusBarColor(), (int) ((1f - rawOffset) * statusBarAlpha)));
      } else if (elasticOffsetPixels == 0) {
        // reset
        activity.getWindow().setStatusBarColor(AppUtil.Companion.modifyAlpha(
